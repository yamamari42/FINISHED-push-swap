...
/*   Updated: 2023/08/17 14:33:59 by mmardere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	do_rev_rotate_both(t_node **a, t_node **b,
...
void	do_rotate_a(t_node **a, int *cost)
{
	while (*cost)
	{
		if (*cost > 0)
...
void	do_rotate_b(t_node **b, int *cost)
{
	while (*cost)
	{
		if (*cost > 0)
